                ...
                <div className="form-section">
                    ...
                    <div id="categories-checkbox" className="form-group checkbox">
                        <div className="control">
                            ...
                            <input type="checkbox" id="category-1" value="restauración" onChange={updateCategories} required></input>
                        </div>
                        <div className="control">
                            <label htmlFor="category-2">Bar</label>
                            <input type="checkbox" id="category-2" value="bar" onChange={updateCategories} required></input>
                        </div>
                        <div className="control">
                            <label htmlFor="category-3">Restaurante</label>
                            <input type="checkbox" id="category-3" value="restaurante" onChange={updateCategories} required></input>
                        </div>
                        <div className="control">
                            <label htmlFor="category-4">Alojamiento</label>
                            <input type="checkbox" id="category-4" value="alojamiento" onChange={updateCategories} required></input>
                        </div>
                        <div className="control">
                            <label htmlFor="category-5">Hotel</label>
                            <input type="checkbox" id="category-5" value="hotel" onChange={updateCategories} required></input>
                        </div>
                        <div className="control">
                            <label htmlFor="category-6">Hostal</label>
                            <input type="checkbox" id="category-6" value="hostal" onChange={updateCategories} required></input>
                        </div>
                        <div className="control">
                            <label htmlFor="category-7">Apartamento</label>
                            <input type="checkbox" id="category-7" value="apartamento" onChange={updateCategories} required></input>
                        </div>
                        <div className="control">
                            <label htmlFor="category-8">Monumento</label>
                            <input type="checkbox" id="category-8" value="monumento" onChange={updateCategories} required></input>
                        </div>
                        <div className="control">
                            <label htmlFor="category-9">Puente</label>
                            <input type="checkbox" id="category-9" value="puente" onChange={updateCategories} required></input>
                        </div>
                        <div className="control">
                            <label htmlFor="category-10">Plaza</label>
                            <input type="checkbox" id="category-10" value="plaza" onChange={updateCategories} required></input>
                        </div>
                    </div>
                </div>
                <div className="form-section">
