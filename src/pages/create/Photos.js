        ...
        <>
            ...
            <div id="photos" className="form-group">
                <div className="control">
                    ...
                    <input type="text" className="form-control link" placeholder="Enlace" name="foto-1" defaultValue={getLink(0)} onInput={updatePhotos}></input>
                ...
                <div className="control">
                    ...
                    <input type="text" className="form-control link" placeholder="Enlace" name="foto-2" defaultValue={getLink(1)} onInput={updatePhotos}></input>
                ...
                <div className="control">
                    ...
                    <input type="text" className="form-control link" placeholder="Enlace" name="foto-3" defaultValue={getLink(2)} onInput={updatePhotos}></input>
