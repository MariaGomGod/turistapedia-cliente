        ...
        <>
            ...
            <div id="photos" className="form-group">
                <div className="control">
                    ...
                    <input type="text" className="form-control link" placeholder="Enlace" id="foto-1" name="foto-1" defaultValue={getLink(0)} onInput={updatePhotos}></input>
                    <input type="text" className="form-control description" placeholder="Descripción" name="desc-foto-1" defaultValue={getDescription(0)} onInput={updatePhotos}></input>
                </div>
                <div className="control">
                    <label htmlFor="foto-2">&nbsp;Foto&nbsp;2</label>
                    <input type="text" className="form-control link" placeholder="Enlace" id="foto-2" name="foto-2" defaultValue={getLink(1)} onInput={updatePhotos}></input>
                    <input type="text" className="form-control description" placeholder="Descripción" name="desc-foto-2" defaultValue={getDescription(1)} onInput={updatePhotos}></input>
                </div>
                <div className="control">
                    <label htmlFor="foto-3">&nbsp;Foto&nbsp;3</label>
                    <input type="text" className="form-control link" placeholder="Enlace" id="foto-3" name="foto-3" defaultValue={getLink(2)} onInput={updatePhotos}></input>
                    <input type="text" className="form-control description" placeholder="Descripción" name="desc-foto-3" defaultValue={getDescription(2)} onInput={updatePhotos}></input>
                </div>
            </div>
        </>
    )
