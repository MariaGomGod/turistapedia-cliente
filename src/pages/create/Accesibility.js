        ...
        <>
            ...
            <div id="accesible-checkbox" className="form-group checkbox">
                <div className="control">
                    ...
                    <input type="checkbox" id="accesible-1" value="adaptedToilet" defaultChecked={pointOfInterest.accessible?.adaptedToilet} onInput={e => updateCheckboxField(e, "accessible")}></input><br />
                </div>
                <div className="control">
                    <label htmlFor="accesible-2">Acceso&nbsp;adaptado</label>
                    <input type="checkbox" id="accesible-2" value="adaptedAccess" defaultChecked={pointOfInterest.accessible?.adaptedAccess} onInput={e => updateCheckboxField(e, "accessible")}></input><br />
                </div>
                <div className="control">
                    <label htmlFor="accesible-3">Habitaciones&nbsp;adaptadas</label>
                    <input type="checkbox" id="accesible-3" value="adaptedRoom" defaultChecked={pointOfInterest.accessible?.adaptedRoom} onInput={e => updateCheckboxField(e, "accessible")}></input><br />
                </div>
                <div className="control">
                    <label htmlFor="accesible-4">Audio&nbsp;guía</label>
                    <input type="checkbox" id="accesible-4" value="audioGuide" defaultChecked={pointOfInterest.accessible?.audioGuide} onInput={e => updateCheckboxField(e, "accessible")}></input><br />
                </div>
            </div>
        </>
    )
